...
- **`src/fanteam-planner.js`** — simulador puro del plan encadenado de seis jornadas, con presupuesto, FT y baseline sin transferencias.
...
- `FanTeamPlanner` encadena esas transiciones durante un máximo de seis jornadas, recalcula XI y capitanía y compara la ruta con el baseline de la plantilla inicial sin mutar el estado. Recibe proyección, finanzas y transferencias mediante adaptadores.
